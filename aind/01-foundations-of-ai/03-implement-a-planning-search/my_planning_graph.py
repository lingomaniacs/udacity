...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        # first determine all possible literal S nodes based on effects in A level
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return bool(
            # Do actions from node 2 negate actions in node 1?
            set(node_a1.action.effect_add) & set(node_a2.action.effect_rem) |
            # Do actions from node 1 negate actions in node 2?
